...
```bash
python $BIOINFOFLOW_SKILLS_ROOT/ngs-runtime-env/scripts/ngs_preflight.py --pipeline bcl_to_fastq --emit-install-plan
```
...
Use the skill-bundled runner when the user provides a local run folder and sample sheet:
