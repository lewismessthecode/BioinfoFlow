...
DEFAULT_REFERENCE_REGISTRY = SKILL_ROOT / "references" / "reference-registry.json"
DEFAULT_DATABASE_REGISTRY = SKILL_ROOT / "references" / "database-registry.json"
...
def validation_command_for_resource(action: dict[str, Any]) -> str:
    ...
    return (
        "python $BIOINFOFLOW_SKILLS_ROOT/ngs-runtime-env/scripts/ngs_reference_manager.py check "
