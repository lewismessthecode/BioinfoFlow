...
DADA2_BACKEND_SCRIPT = SKILL_ROOT / "workflows" / "amplicon_microbiome" / "run_dada2_backend.R"
...
def build_nfcore_plan(args: argparse.Namespace) -> list[dict[str, Any]]:
    cmd = [
        "python",
        "$BIOINFOFLOW_SKILLS_ROOT/ngs-runtime-env/scripts/run_nfcore_pipeline.py",
        "--pipeline",
        "ampliseq",
        "--sample-sheet",
