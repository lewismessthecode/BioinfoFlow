...
## [0.3.0](https://github.com/lewismessthecode/BioinfoFlow/compare/0.2.0...0.3.0) (2026-09-10)


### Features

* add agent trace client contract ([59f0bcf](https://github.com/lewismessthecode/BioinfoFlow/commit/59f0bcf980a30b58830db3b7c3cf9be16d9dacce))
...
* add session-scoped workspace drawer tabs ([445b118](https://github.com/lewismessthecode/BioinfoFlow/commit/445b118d387a246bb4bb6ad8fe93d9115e2c6723))
* add trace-first agent view ([444d9b1](https://github.com/lewismessthecode/BioinfoFlow/commit/444d9b16efa118c100f35a48a22bd51cc57c004f))
* adopt DeepSeek sandbox confinement ([2806ecf](https://github.com/lewismessthecode/BioinfoFlow/commit/2806ecf83e2f3a09b08ee973dfbb4f3a0644f4e9))
* capture agent model traces ([4200994](https://github.com/lewismessthecode/BioinfoFlow/commit/4200994395adcc59c226a1560805f25eeb374be5))
* connect agent activity to run progress ([7f5b12a](https://github.com/lewismessthecode/BioinfoFlow/commit/7f5b12aa3859e9c616096d27e15ead8a1fa9052d))
* define pi harness host ports ([551cd62](https://github.com/lewismessthecode/BioinfoFlow/commit/551cd62ba5dff84ec2bd22531112923f4573d292))
* expose stable agent trace contract ([e3d311a](https://github.com/lewismessthecode/BioinfoFlow/commit/e3d311a909801b5aa1c3826cd4204332220e0e49))
* preview Excel artifacts ([488b446](https://github.com/lewismessthecode/BioinfoFlow/commit/488b44648a5ba75dd7a020855514afff3c178aaa))
* refine agent thinking and tool activity ([b2396c0](https://github.com/lewismessthecode/BioinfoFlow/commit/b2396c05f4112a8b33dcce0b0cfe0c779442a21b))
* refine agent trace context navigation ([1891639](https://github.com/lewismessthecode/BioinfoFlow/commit/1891639ec63021900e5f11a7a661e5b8bd1c7ddd))
* restore agent composer and workspace entry ([a796950](https://github.com/lewismessthecode/BioinfoFlow/commit/a7969508a077503f4d6587ead539c6d8e668e93e))
* restore agent conversation experience ([9d79202](https://github.com/lewismessthecode/BioinfoFlow/commit/9d792028c9cb4f8fe87b23f999ed934f9b6595e9))
* restore agent workspace artifact cards ([1e580f0](https://github.com/lewismessthecode/BioinfoFlow/commit/1e580f09111597e47da37026d232f1ca276f26b3))
* separate artifacts from tool output ([7ced5ca](https://github.com/lewismessthecode/BioinfoFlow/commit/7ced5ca371355fc1ad48e0f0e6dad14f4150927c))
* stabilize agent workspace for 0.3 ([cdf0852](https://github.com/lewismessthecode/BioinfoFlow/commit/cdf08528adb2eee107f3ad815fee062979b496b4))
* version published artifacts ([be1a887](https://github.com/lewismessthecode/BioinfoFlow/commit/be1a887877317f27ab58efc7c125c4b31bc9482b))


### Bug Fixes

* align terminal dock surfaces ([4f8275a](https://github.com/lewismessthecode/BioinfoFlow/commit/4f8275a7bc7496e9a34de207ff1e43eae3e1da7a))
* allow scoped agent file commands ([50495ce](https://github.com/lewismessthecode/BioinfoFlow/commit/50495ce23e33e453b926c25b3d368789c718c541))
* clarify approvals and restore local sandbox setup ([978c114](https://github.com/lewismessthecode/BioinfoFlow/commit/978c11486642ad0d00618f67218cdd18af4950be))
* close agent presentation audit gaps ([d4e4621](https://github.com/lewismessthecode/BioinfoFlow/commit/d4e4621e787d6e30d5f52595c2f7b0f028b85dd2))
* close agent presentation review gaps ([189eb33](https://github.com/lewismessthecode/BioinfoFlow/commit/189eb33d32cc170f6216b950b17ac7e6af80dcdc))
* close agent UI review gaps ([831bd04](https://github.com/lewismessthecode/BioinfoFlow/commit/831bd041f64fccacad686c898f94e5e61212861a))
* close agent workspace review gaps ([1a0e4ba](https://github.com/lewismessthecode/BioinfoFlow/commit/1a0e4bae38eab7b2434f480a324034f3f3516851))
* close provider and session lifecycle gaps ([13d7c17](https://github.com/lewismessthecode/BioinfoFlow/commit/13d7c172063aa7caa13225c86948c2635126fc8a))
* complete agent run audit contract ([5fada2b](https://github.com/lewismessthecode/BioinfoFlow/commit/5fada2b0fae22a2d025d542915b2c819346cf6d5))
* complete agent trace telemetry ([974866b](https://github.com/lewismessthecode/BioinfoFlow/commit/974866b3dcb8bb0a9d55d2dbe3b966a360cbd3d4))
* delete project conversations with workspace ([700ee62](https://github.com/lewismessthecode/BioinfoFlow/commit/700ee626607bdf0a294fe86f480fce6884c40467))
* discard legacy bash output details ([2f34402](https://github.com/lewismessthecode/BioinfoFlow/commit/2f344027c017af57f8062825d6a7fb2f8eee1477))
...
* enforce stable agent presentation boundary ([42da0ef](https://github.com/lewismessthecode/BioinfoFlow/commit/42da0ef70eff052ea21fbb905d0289b289395640))
* finish agent conversation UI restoration ([f5dd9b0](https://github.com/lewismessthecode/BioinfoFlow/commit/f5dd9b019a2e52110c9075bfbba44a5279bc74b0))
* finish agent runtime leases during shutdown ([1a98c94](https://github.com/lewismessthecode/BioinfoFlow/commit/1a98c941b73a3a7de4d0b6e1e3e9a4ebbc9ac4c5))
...
* harden agent environment and approval boundaries ([8a0d01c](https://github.com/lewismessthecode/BioinfoFlow/commit/8a0d01cd94623fa04db1315f8424c4158be687e7))
* harden agent public tool projections ([0f78b72](https://github.com/lewismessthecode/BioinfoFlow/commit/0f78b72fc2251f764546840e141cef180e97f139))
* harden agent trace inspector ([f9025f9](https://github.com/lewismessthecode/BioinfoFlow/commit/f9025f9afa9379fb52d8ec68165e49c23f6a1be5))
* hide absolute paths in agent tool details ([aa0561a](https://github.com/lewismessthecode/BioinfoFlow/commit/aa0561a63ae3083275bfed09a81293bcd9504ff7))
* keep bash output private in agent views ([0c3564f](https://github.com/lewismessthecode/BioinfoFlow/commit/0c3564fe3b2d2c1f1ab515822f3dbe49a794a879))
* keep conversations visible after project deletion ([b56789c](https://github.com/lewismessthecode/BioinfoFlow/commit/b56789c69675a4655a551a48bb6290e6dcf623bf))
* keep drawer selection state coherent ([3f0eaab](https://github.com/lewismessthecode/BioinfoFlow/commit/3f0eaab801dc146d50d66ed718ded00e62318eb8))
* keep trace rail visible beside workspace panels ([9f672ac](https://github.com/lewismessthecode/BioinfoFlow/commit/9f672ac3cde4b15d5ef0eb8de021aa8d2383d6f5))
* load provider icons without lobe ui ([203d444](https://github.com/lewismessthecode/BioinfoFlow/commit/203d444137dc71e43a570a5a2693a26d71b13bc1))
* localize drawer tab close labels ([d71bb2e](https://github.com/lewismessthecode/BioinfoFlow/commit/d71bb2e587850d0bc6eed91f6f86ad45773d14b5))
...
* make agent session streaming recover safely ([35c6bb3](https://github.com/lewismessthecode/BioinfoFlow/commit/35c6bb3b9640115cf4b9b4d53f180785388e560f))
* polish agent composer and workspace controls ([4cd5ce3](https://github.com/lewismessthecode/BioinfoFlow/commit/4cd5ce3ffd4c515194ecfe76dac00e5ff9ca2b4c))
* polish agent composer semantics ([d268f6b](https://github.com/lewismessthecode/BioinfoFlow/commit/d268f6bc845f696ff223dceb9bb74ef2f022d268))
* polish agent touch interactions ([0a82795](https://github.com/lewismessthecode/BioinfoFlow/commit/0a8279562acc0f41d5beda0b890bda57f7c85067))
...
* preserve agent activity disclosure and performance ([c903508](https://github.com/lewismessthecode/BioinfoFlow/commit/c903508926ea481c5bcc75c844a12db26a95a110))
* preserve agent activity order ([f113d7f](https://github.com/lewismessthecode/BioinfoFlow/commit/f113d7ff39475efc80deb8099d8926a03e3eb675))
...
* preserve agent trace adapter boundaries ([f4fa549](https://github.com/lewismessthecode/BioinfoFlow/commit/f4fa549b4359e99ce53fc85f167aa4c0a0dca99b))
* preserve provider tool rounds and plan state ([b9da0b8](https://github.com/lewismessthecode/BioinfoFlow/commit/b9da0b85ff9d289171d949f2d6ac39a5df813f0b))
* preserve stable agent transcript rendering ([9df3138](https://github.com/lewismessthecode/BioinfoFlow/commit/9df31388eb595890587e08e9cec685c91381c560))
* publish safe agent tool details ([d10628c](https://github.com/lewismessthecode/BioinfoFlow/commit/d10628cba8ae21c95ad8efaeb2437a3d8d57602a))
* recover interrupted agent tool rounds ([4314140](https://github.com/lewismessthecode/BioinfoFlow/commit/43141403b71cdd36c8b5826cba85d46d2ec6bd89))
* refine agent transcript experience ([fdc03a3](https://github.com/lewismessthecode/BioinfoFlow/commit/fdc03a37fbd8dcba09c89438ff282ebb84fbc2f8))
* refine agent transcript presentation ([16b00d6](https://github.com/lewismessthecode/BioinfoFlow/commit/16b00d65d4c6f8f9bf10f3b09e43ad7816fe834e))
* refine agent transcript presentation ([b372f63](https://github.com/lewismessthecode/BioinfoFlow/commit/b372f63bdfec28e970ffdc3c9b6da8f9149b3918))
* refresh automatic agent titles safely ([1459be2](https://github.com/lewismessthecode/BioinfoFlow/commit/1459be2de6866c24f5c29efb99d4e56df55214a8))
* remove agent composer halo ([9494724](https://github.com/lewismessthecode/BioinfoFlow/commit/949472418e6006e0f55bf6da7600bd4e691a0c6f))
* remove placeholder endpoints and heavy stream probes ([fad7b8d](https://github.com/lewismessthecode/BioinfoFlow/commit/fad7b8dd393cce2697b853e3582a418f14b2dda2))
* require durable provider and stream lifecycles ([1b29dab](https://github.com/lewismessthecode/BioinfoFlow/commit/1b29dab7cae3680c89ef5e22f5162a3e7c72b5aa))
* restore agent composer polish ([7311f0c](https://github.com/lewismessthecode/BioinfoFlow/commit/7311f0cd7f9c26bfb6c9decc67dec462f6e558d7))
* restore agent transcript jump to latest ([c2dea2a](https://github.com/lewismessthecode/BioinfoFlow/commit/c2dea2ada350ec2f8c380a97f51927000ebbee91))
...
* restore refined agent draft workspace ([68d9170](https://github.com/lewismessthecode/BioinfoFlow/commit/68d9170abb41ac7473800d9eb34ea59e273fb1e2))
* restore saved workspace file previews ([342f6e8](https://github.com/lewismessthecode/BioinfoFlow/commit/342f6e8ea7469cdbd5c214324a8dc5e24da965f8))
...
* scope transcript artifacts to their creating turn ([dfe5844](https://github.com/lewismessthecode/BioinfoFlow/commit/dfe5844e4fc1f15c4937cb50414f7a3386cb7d96))
...
* stabilize agent tool and adapter recovery ([627342f](https://github.com/lewismessthecode/BioinfoFlow/commit/627342fba6ab4d10efc56018a3613fcccfcc4b04))
* sync artifact presentation contract ([659a449](https://github.com/lewismessthecode/BioinfoFlow/commit/659a4498683bbd16814ff2d453ea5f71cf88c463))
* tolerate partial legacy schemas in tool output migration ([44fcd0c](https://github.com/lewismessthecode/BioinfoFlow/commit/44fcd0c2f5ffdb9b8a2974480842cd6f59e53afe))
* unify agent composer controls ([0828015](https://github.com/lewismessthecode/BioinfoFlow/commit/0828015b241ed9d89e432876268a09732cbc07e2))
* unmount trace inspector on conversation switch ([d2d5290](https://github.com/lewismessthecode/BioinfoFlow/commit/d2d5290e67c884f72fa1dad0b49c44ff7cf52f46))
* use object ports in Cursor environment ([2435d34](https://github.com/lewismessthecode/BioinfoFlow/commit/2435d341277a95319391b4b863ecc5b16a4515da))
