  ...
  useTranslations: (namespace: string) =>
    (key: string, values?: Record<string, string | number>) => {
      const copy: Record<string, string> = {
        ...
        "agentComposer.permission.ask_changes.description": "Ask before changes.",
        "agentComposer.permission.ask_dangerous.name": "Approve safe actions",
        "agentComposer.permission.ask_dangerous.description": "Ask for dangerous actions.",
        "agentComposer.permission.full_access.name": "Full access",
        "agentComposer.permission.full_access.description": "Run automatically.",
