...
PROVIDER_TEMPLATES: tuple[ProviderTemplate, ...] = (
    ...
    ProviderTemplate(
        ...
        env_api_key_vars=("KIMI_CN_API_KEY", "MOONSHOT_CN_API_KEY", "MOONSHOT_API_KEY"),
        litellm_model_prefix="openai/",
    ),
    ProviderTemplate(
        id="qwen",
    ...
    ProviderTemplate(
        ...
        litellm_model_prefix="openai/",
        metadata={"modelDiscoveryBaseUrl": "https://api.cohere.com/v1"},
    ),
    ProviderTemplate(
        id="together",
        name="Together AI",
    ...
    ProviderTemplate(
        ...
        models=(
            ModelTemplate(id="sonar", name="Sonar", context_length=128000),
            ModelTemplate(id="sonar-pro", name="Sonar Pro", context_length=200000),
            ModelTemplate(
